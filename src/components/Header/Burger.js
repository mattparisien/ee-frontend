...
function Burger() {
	...
	const pseudoClasses = {
		common:
			"after:absolute before:absolute after:top-1/2 after:left-1/2 after:w-[30px] after:h-[2px] before:top-1/2 before:left-1/2 before:w-[30px] before:h-[2px] before:transition before:transform before:duration-[300ms] before:ease-[cubic-bezier(0.35, 0.755, 0.42, 0.95)] after:transition after:transform after:duration-[300ms] after:ease-[cubic-bezier(0.35, 0.755, 0.42, 0.95)]",
	};
