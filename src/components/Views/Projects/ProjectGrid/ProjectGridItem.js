...
export const Frame = ({ isHovering }) => {
	...
	const xInitial = {
		transform: `scaleX(${isHovering ? 1 : 0})`,
		transformOrigin: "left",
	};

	const yInitial = {
		transform: `scaleY(${isHovering ? 1 : 0})`,
	};

	const transition = {
		transition: "transform cubic-bezier(0.86, 0, 0.07, 0.995)",
	...
	return (
		<div className='c-frame' style={wrapper}>
			<svg
